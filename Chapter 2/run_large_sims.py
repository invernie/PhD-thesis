...
filepathrug = "Path/To/File/out_rug_" + str(stones) +"stones"
...
# read saved files
loadfilepathFD = "Path/To/File/out_FD_1000"
loadfilepathT = "Path/To/File/out_T_1000"

fileFD = open(loadfilepathFD, 'rb')
allResFD = pickle.load(fileFD)
fileFD.close()
aveF_FD = np.mean([F[0] for F in allResFD])

fileT = open(loadfilepathT, 'rb')
allResT = pickle.load(fileT)
fileT.close()
aveF_T = np.mean([F[0] for F in allResT])

filerug = open(loadfilepathT, 'rb')
allResrug = pickle.load(fileT)
filerug.close()
aveF_rug = np.mean([F[0] for F in allResrug])
...
loadpath = "C:/Users/FastRun/OneDrive - University of St Andrews/Projects/T_albipennis_ABM/results/out_FD_5000stones"
...
## rugatulus files
loadpath = "Path/To/File/out_rug_1000stones"
...
savepath = "Path/To/File/stone_n_results_with_rug.csv"
...
listOfLists = [CoVList_FD1000, CoVList_FD3000, CoVList_FD5000, RbarList_FD1000, RbarList_FD3000, RbarList_FD5000, CoVList_T1000, CoVList_T3000, CoVList_T5000, RbarList_T1000, RbarList_T3000, RbarList_T5000, CoVList_r1000, CoVList_r3000, RbarList_r1000, RbarList_r3000]
savepathL = "Path/To/File/Rbar_and_CoV_values_with_rug.csv"
with open(savepathL, mode = "w", newline='') as lists_file:
    ...
    list_writer.writerow(["SO1000_CoV", "SO3000_CoV", "SO5000_CoV", "SO1000_Rbar", "SO3000_Rbar", "SO5000_Rbar", "T1000_CoV", "T3000_CoV", "T5000_CoV", "T1000_Rbar", "T3000_Rbar", "T5000_Rbar", "r1000_CoV", "r3000_CoV", "r1000_Rbar", "r3000_Rbar"])
...
outList75000 = list()
for s in range(S):
   out = w.rugatulus_delayed(s,0,18, stones = stones)
   ...
   print("rugatulus_delayed sim is at:" + str(s))
   
filepath5000 = "Path/To/File/out_rug_delayed24_T5000" + str(stones) +"stones"
filepath6000 = "Path/To/File/out_rug_delayed24_T6000" + str(stones) +"stones"
filepath7500 = "Path/To/File/out_rug_delayed24_T7500" + str(stones) +"stones"
filepath10000 = "Path/To/File/out_rug_delayed24_T10000" + str(stones) +"stones"
filepath20000 = "Path/To/File/out_rug_delayed24_T20000" + str(stones) +"stones"
filepath50000 = "Path/To/File/out_rug_delayed24_T50000" + str(stones) +"stones"
filepath75000 = "Path/To/File/out_rug_delayed24_T75000" + str(stones) +"stones"
...
fsteps = 10
loadpath1 = "Path/To/File/out_rug_delayed24_T50003000stones"
...
fsteps = 10
loadpath2 = "Path/To/File/out_rug_delayed24_T60003000stones"
...
fsteps = 10
loadpath3 = "Path/To/File/out_rug_delayed24_T75003000stones"
...
loadpath4 = "Path/To/File/out_rug_delayed24_T100003000stones"
...
loadpath5 = "Path/To/File/out_rug_delayed24_T200003000stones"
...
loadpath6 = "Path/To/File/out_rug_delayed24_T500003000stones"
...
loadpath7 = "Path/To/File/out_rug_delayed24_T750003000stones"
...
savepathd = "Path/To/File/Rbar_and_CoV_values_rug_delayed.csv"
...
imgs = [imd24_6000, imd24_10000, imd24_75000]
axs = axs.flatten()
...
plt.show()
plt.savefig('Path/To/File/walls_rug_delayed24.png', dpi=350)
